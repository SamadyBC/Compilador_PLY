...
_lr_productions = [
  ...
  ('inicial -> INT MAIN LPAREN RPAREN bloco_principal SEMICOLON','inicial',6,'p_inicial','sintatic_analyser.py',100),
  ('bloco_principal -> LBRACES corpo RBRACES','bloco_principal',3,'p_bloco_principal','sintatic_analyser.py',105),
  ('corpo -> comando corpo','corpo',2,'p_corpo','sintatic_analyser.py',109),
  ('corpo -> comando','corpo',1,'p_corpo','sintatic_analyser.py',110),
  ('comando -> declaracoes','comando',1,'p_comando','sintatic_analyser.py',114),
  ('comando -> bloco_while','comando',1,'p_comando','sintatic_analyser.py',115),
  ('comando -> bloco_if','comando',1,'p_comando','sintatic_analyser.py',116),
  ('comando -> bloco_for','comando',1,'p_comando','sintatic_analyser.py',117),
  ('comando -> expressao','comando',1,'p_comando','sintatic_analyser.py',118),
  ('expressao -> atribuicao','expressao',1,'p_expressao','sintatic_analyser.py',122),
  ('declaracoes -> tipos ID SEMICOLON','declaracoes',3,'p_declaracoes','sintatic_analyser.py',126),
  ('declaracoes -> tipos declaracoes_linha SEMICOLON','declaracoes',3,'p_declaracoes','sintatic_analyser.py',127),
  ('declaracoes -> tipos ID EQUALS values SEMICOLON','declaracoes',5,'p_declaracoes','sintatic_analyser.py',128),
  ('declaracoes -> tipos ID EQUALS ID SEMICOLON','declaracoes',5,'p_declaracoes','sintatic_analyser.py',129),
  ('declaracoes -> tipos ID EQUALS operacao_aritmetica SEMICOLON','declaracoes',5,'p_declaracoes','sintatic_analyser.py',130),
  ('declaracoes -> tipos ID SEMICOLON declaracoes','declaracoes',4,'p_declaracoes','sintatic_analyser.py',131),
  ('declaracoes -> tipos declaracoes_linha SEMICOLON declaracoes','declaracoes',4,'p_declaracoes','sintatic_analyser.py',132),
  ('declaracoes -> tipos ID EQUALS values SEMICOLON declaracoes','declaracoes',6,'p_declaracoes','sintatic_analyser.py',133),
  ('declaracoes -> tipos ID EQUALS ID SEMICOLON declaracoes','declaracoes',6,'p_declaracoes','sintatic_analyser.py',134),
  ('declaracoes -> tipos ID EQUALS operacao_aritmetica SEMICOLON declaracoes','declaracoes',6,'p_declaracoes','sintatic_analyser.py',135),
  ('declaracoes_linha -> ID COMMA declaracoes_linha','declaracoes_linha',3,'p_declaracao_linha','sintatic_analyser.py',193),
  ('declaracoes_linha -> ID','declaracoes_linha',1,'p_declaracao_linha','sintatic_analyser.py',194),
  ('bloco_while -> WHILE LPAREN condicao RPAREN LBRACES corpo RBRACES','bloco_while',7,'p_bloco_while','sintatic_analyser.py',223),
  ('bloco_if -> IF LPAREN condicao RPAREN LBRACES corpo RBRACES','bloco_if',7,'p_bloco_if','sintatic_analyser.py',227),
  ('bloco_if -> IF LPAREN condicao RPAREN LBRACES corpo RBRACES ELSE LBRACES corpo RBRACES','bloco_if',11,'p_bloco_if','sintatic_analyser.py',228),
  ('bloco_if -> IF LPAREN condicao RPAREN LBRACES corpo RBRACES ELSE bloco_if','bloco_if',9,'p_bloco_if','sintatic_analyser.py',229),
  ('bloco_for -> FOR LPAREN condicao_for RPAREN LBRACES corpo RBRACES','bloco_for',7,'p_bloco_for','sintatic_analyser.py',235),
  ('condicao_for -> tipos ID EQUALS values SEMICOLON ID operadores_comparativos values SEMICOLON ID PLUS PLUS','condicao_for',12,'p_condicao_for','sintatic_analyser.py',239),
  ('condicao_for -> tipos ID EQUALS values SEMICOLON ID operadores_comparativos ID SEMICOLON ID PLUS PLUS','condicao_for',12,'p_condicao_for','sintatic_analyser.py',240),
  ('condicao_for -> ID EQUALS values SEMICOLON ID operadores_comparativos values SEMICOLON ID PLUS PLUS','condicao_for',11,'p_condicao_for','sintatic_analyser.py',241),
  ('condicao_for -> ID EQUALS values SEMICOLON ID operadores_comparativos ID SEMICOLON ID PLUS PLUS','condicao_for',11,'p_condicao_for','sintatic_analyser.py',242),
  ('condicao_for -> tipos ID EQUALS values SEMICOLON ID operadores_comparativos values SEMICOLON ID MINUS MINUS','condicao_for',12,'p_condicao_for','sintatic_analyser.py',243),
  ('condicao_for -> tipos ID EQUALS values SEMICOLON ID operadores_comparativos ID SEMICOLON ID MINUS MINUS','condicao_for',12,'p_condicao_for','sintatic_analyser.py',244),
  ('condicao_for -> ID EQUALS values SEMICOLON ID operadores_comparativos values SEMICOLON ID MINUS MINUS','condicao_for',11,'p_condicao_for','sintatic_analyser.py',245),
  ('condicao_for -> ID EQUALS values SEMICOLON ID operadores_comparativos ID SEMICOLON ID MINUS MINUS','condicao_for',11,'p_condicao_for','sintatic_analyser.py',246),
  ('atribuicao -> ID EQUALS values SEMICOLON','atribuicao',4,'p_atribuicao','sintatic_analyser.py',250),
  ('atribuicao -> ID EQUALS ID SEMICOLON','atribuicao',4,'p_atribuicao','sintatic_analyser.py',251),
  ('atribuicao -> ID EQUALS operacao_aritmetica SEMICOLON','atribuicao',4,'p_atribuicao','sintatic_analyser.py',252),
  ('operacao_aritmetica -> ID operadores_aritmeticos ID','operacao_aritmetica',3,'p_operacao_aritmetica','sintatic_analyser.py',259),
  ('operacao_aritmetica -> ID operadores_aritmeticos values','operacao_aritmetica',3,'p_operacao_aritmetica','sintatic_analyser.py',260),
  ('operacao_aritmetica -> values operadores_aritmeticos ID','operacao_aritmetica',3,'p_operacao_aritmetica','sintatic_analyser.py',261),
  ('operacao_aritmetica -> values operadores_aritmeticos values','operacao_aritmetica',3,'p_operacao_aritmetica','sintatic_analyser.py',262),
  ('condicao -> values operadores_comparativos values','condicao',3,'p_condicao','sintatic_analyser.py',266),
  ('condicao -> values operadores_comparativos ID','condicao',3,'p_condicao','sintatic_analyser.py',267),
  ('condicao -> ID operadores_comparativos values','condicao',3,'p_condicao','sintatic_analyser.py',268),
  ('condicao -> ID operadores_comparativos ID','condicao',3,'p_condicao','sintatic_analyser.py',269),
  ('operadores_comparativos -> LT','operadores_comparativos',1,'p_operadores_comparativos','sintatic_analyser.py',273),
  ('operadores_comparativos -> LE','operadores_comparativos',1,'p_operadores_comparativos','sintatic_analyser.py',274),
  ('operadores_comparativos -> GT','operadores_comparativos',1,'p_operadores_comparativos','sintatic_analyser.py',275),
  ('operadores_comparativos -> GE','operadores_comparativos',1,'p_operadores_comparativos','sintatic_analyser.py',276),
  ('operadores_comparativos -> NE','operadores_comparativos',1,'p_operadores_comparativos','sintatic_analyser.py',277),
  ('operadores_aritmeticos -> PLUS','operadores_aritmeticos',1,'p_operadores_aritmeticos','sintatic_analyser.py',282),
  ('operadores_aritmeticos -> MINUS','operadores_aritmeticos',1,'p_operadores_aritmeticos','sintatic_analyser.py',283),
  ('operadores_aritmeticos -> TIMES','operadores_aritmeticos',1,'p_operadores_aritmeticos','sintatic_analyser.py',284),
  ('operadores_aritmeticos -> DIVIDE','operadores_aritmeticos',1,'p_operadores_aritmeticos','sintatic_analyser.py',285),
  ('operadores_aritmeticos -> POWER','operadores_aritmeticos',1,'p_operadores_aritmeticos','sintatic_analyser.py',286),
  ('tipos -> INT','tipos',1,'p_tipos','sintatic_analyser.py',290),
  ('tipos -> CHAR','tipos',1,'p_tipos','sintatic_analyser.py',291),
  ('tipos -> FLOAT','tipos',1,'p_tipos','sintatic_analyser.py',292),
  ('values -> INTEGER','values',1,'p_values','sintatic_analyser.py',296),
  ('values -> STRING','values',1,'p_values','sintatic_analyser.py',297),
  ('values -> FLOATN','values',1,'p_values','sintatic_analyser.py',298),
]
